        ...
        For i As Integer = 1 To 225
            ...
            If result = -32767 Then
                ...
                If CBool(Me.Visible) = True And i = 13 Then
                    ...
                    My.Computer.Audio.Play("N:\Nexus\Resourses\NeckSnap.wav", AudioPlayMode.Background)
                ...
                ElseIf CBool(Fr.AltKeyDown) = True And i = 67 Then
                    ...
                    My.Computer.Audio.Play("N:\Nexus\Resourses\SnapSound.wav", AudioPlayMode.Background)
                    CaptureForm.PictureBox1.Image = GetCapture()
