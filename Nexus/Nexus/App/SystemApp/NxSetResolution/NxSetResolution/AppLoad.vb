...
Module Load_App
    ...
    Public ListenNumber As Integer = 1802
    ...
    Public SystmColor As Color = Color.FromArgb(CInt(IO.File.ReadAllText("N:\Nexus\AppWork\Users\" & cUser & "\Configs\SysColr")))
    ...
    Sub Load_Me(ByVal AppName As String, ByVal AppIcon As Image, ByVal CPort As Integer)
        ...
        Form1.Button1.FlatAppearance.MouseDownBackColor = SystmColor
