Public Class ListaDrep
    ...
    Private Sub PictureBox2_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles PictureBox2.Click
        ...
        Dim NxFileDialog As New NxFileDialog.NxFileDialog
        ...
        If NxFileDialog.ShowDlg() = Windows.Forms.DialogResult.OK Then
            ...
            For Each File As String In NxFileDialog.SelectedFiles
        ...
        '    For Each eFile As String In OpenFileDialog1.FileNames

        '        Dim eInfo As New IO.FileInfo(eFile)

        '        If eInfo.Extension.ToLower = ".nxlp" Then

        '            LoadPlayList(eFile)
        '        Else
        '            LoadToPlayList(eFile)
        '        End If
