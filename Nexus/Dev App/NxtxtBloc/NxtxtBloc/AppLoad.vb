...
Module Load_App
    ...
    Public ListenNumber As Integer = 1899
    ...
    Sub CMD(ByVal Line As String)
        ...
        If Line.StartsWith("+") Then
            ...
            Line = Line.Replace("+", "")
            Dim Ext As String = Line.Substring(Line.Length - 3)

            If Ext.ToLower = "txt" Then
                Form1.NotFormatMod()

                Dim Cont As String = IO.File.ReadAllText(Line)
                Form1.RichTextBox1.Text = Cont


            ElseIf Ext.ToLower = "rtf" Then
                Form1.FormatMod()
                Form1.RichTextBox1.LoadFile(Line)
