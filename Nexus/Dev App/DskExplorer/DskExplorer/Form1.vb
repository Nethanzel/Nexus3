...
Public Class Form1
    ...
    Sub RellenarTV(ByVal root As String)
    ...
    Private Sub Panel7_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Panel7.Click
        ...
        Dim index As Integer = NavegationList.Count - 1

        If index > -1 Then

            Dim Result As String = AbrirDirectorio(NavegationList.Item(index), ListView1, ShowHide, TextBox2.Text, True)

            If Result.Contains("\") Then

                Label2.Visible = False
                TextBox1.Text = AbrirDirectorio(NavegationList.Item(index), ListView1, ShowHide, TextBox2.Text, False)
                NavegationList.RemoveAt(index)
            Else
...
1:
    ...
    Private Sub ListView1_KeyPress(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles ListView1.KeyPress
        ...
        ElseIf e.KeyChar = Microsoft.VisualBasic.ChrW(Keys.Back) Then
            ...
            AddHandler ListView1.KeyPress, AddressOf PictureBox2_Click
    ...
    Private Sub PictureBox2_MouseLeave(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles PictureBox7.MouseLeave, PictureBox6.MouseLeave, PictureBox5.MouseLeave, PictureBox4.MouseLeave, PictureBox2.MouseLeave
        CType(sender, PictureBox).BackColor = Color.Transparent
    End Sub

    Private Sub PictureBox2_MouseDown(ByVal sender As System.Object, ByVal e As System.Windows.Forms.MouseEventArgs) Handles PictureBox7.MouseDown, PictureBox6.MouseDown, PictureBox5.MouseDown, PictureBox4.MouseDown, PictureBox2.MouseDown
