...
Module OwnFiles
    ...
    Dim ExtDir As String = "N:\Nexus\AppWork\NxDisckExplorer\Ext"
    ...
    Sub SpecialDirectories(ByVal Tree As TreeView, ByVal Root As String)
        ...
        Dim rName As String = DesEncriptIt(IO.File.ReadAllText("N:\Users\" & Root & "\Name"))

        Dim fNode As New TreeNode(rName, 12, 12)
        'fNode.NodeFont = New Font("Microsoft Sans Serif", 7, FontStyle.Bold)
        fNode.Tag = 12
        fNode.ToolTipText = "N:\Users\" & Root & "\User"
        Dim iDir As IO.DirectoryInfo
        Dim NodoHijo As TreeNode


        For Each Directorio As String In IO.Directory.GetDirectories(rt)
            iDir = My.Computer.FileSystem.GetDirectoryInfo(Directorio)

            If iDir.Name = "Index" Then
