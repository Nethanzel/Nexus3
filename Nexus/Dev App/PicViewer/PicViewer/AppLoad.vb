...
Module Load_App
    ...
    Public ListenNumber As Integer = 1845
    ...
    Public SystmColor As Color = Color.FromArgb(CInt(IO.File.ReadAllText("NN:\Users\" & cUser & "\Configs\SysColr")))
    ...
    Sub CMD(ByVal Line As String)
        ...
        If Line.StartsWith("+") Then
            ...
            Form1.Add_Imgage(Line.Replace("+", ""), Form1.Panel6)

            Form1.BM1 = Bitmap.FromFile(Line.Replace("+", ""))
            Form1.PictureBox1.Image = Form1.BM1

            Dim ImgExt As New IO.FileInfo(Line.Replace("+", ""))
            Form1.Ext = ImgExt.Extension

            Form1.cImage = Image.FromFile(Line.Replace("+", ""))

            Form1.ScanDirectory(Line.Replace("+", "").Remove(Line.Replace("+", "").LastIndexOf("/")))
        Else
